...
namespace BoilerplateDemo.Tests
{
    public abstract class BoilerplateDemoTestBase : AbpIntegratedTestBase
    {
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<BoilerplateDemoApplicationModule>();
            modules.Add<BoilerplateDemoDataModule>();
        }

        public void UsingDbContext(Action<BoilerplateDemoDbContext> action)
        {
        ...
        public T UsingDbContext<T>(Func<BoilerplateDemoDbContext, T> func)
        {
            T result;
